...
app = FastAPI(
    title="Invoice Expense Classification Framework - v1_NB", 
    description="Engine type: CountVectorizer + Multinomial Naive Bayes"
)

# Load saved Naive Bayes runtime pipeline artifact securely on startup
...
async def predict_expense(payload: InvoiceInput):
    ...
    try:
        # Compute Naive Bayes joint log-likelihood probability distribution
